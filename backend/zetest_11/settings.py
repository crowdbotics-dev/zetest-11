"""
Django settings for zetest_11 project.
...
WSGI_APPLICATION = 'zetest_11.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "zetest_11 API",
    "DESCRIPTION": "API documentation for zetest_11 App",
    "VERSION": "v1",
}
